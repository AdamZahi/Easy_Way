...
import tn.esprit.models.trajet.User;
...
//                LocalDateTime dateCreation = timestamp.toLocalDateTime();
    ...
    public int getClientIdByCredentials(String nom, String prenom, String email, String password){
        String query = "SELECT id_user FROM user WHERE nom = ? AND prenom = ? AND email = ? AND mot_de_passe = ?";
