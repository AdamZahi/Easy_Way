...
public class reservercov {
    ...
    public void initialize() {
        ...
        System.out.println("montant field: " + montant); // Debug

        if (montant == null) {
            System.out.println("❌ montant est NULL ! Vérifiez le fichier FXML.");
        }
    }
    ...
    public void setSelectedPost(Posts post) {
        ...
        if (spinnerPlaces != null) {
            ...
            spinnerPlaces.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 10, 1));
